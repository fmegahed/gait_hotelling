...
```{r T2ProfilesPlot, eval=FALSE, fig.align='center', results='asis', out.width="100%"}
...
```{r T2FeaturesPlot, eval=FALSE, fig.align='center', results='asis', out.width="100%"}
